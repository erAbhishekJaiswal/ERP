...
const CourseForm = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // if (id) {
        //   const courseResponse = await axios.get(`http://localhost:5000/api/features/course/${id}`);
        //   setFormData(courseResponse.data.getCourse);
        // }
      } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        // Create new course
        await apiClient.post('/api/features/createCourse', formData);
    ...
    <div className="course-form-container">
      ...
      <form onSubmit={handleSubmit} className="course-form">
        ...
        <div className="form-actions">
          <button type="button" onClick={() => navigate('/admin/courselist')} className="cancel-button">
            Cancel
          </button>
